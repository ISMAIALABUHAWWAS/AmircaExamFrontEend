                ...
                <div class="modal-dialog modal-dialog-centered modal-dialog-scrollable">
                    <div class="modal-content">
                        <div class="modal-header">
                            <h5 class="modal-title" id="exampleModalLabel">{{ selectedCard ? selectedCard.type : '' }}
                            </h5>
                            <button type="button" class="btn btn-primary" @click="toggleCardSide">{{ cardSide ===
                                'front' ?
                ...
                <div class="modal-content">
                    ...
                    <div class="modal-footer">
                        <button type="button" class="btn btn-secondary" data-bs-dismiss="modal"
                            data-bs-target="#exampleModal13" data-bs-whatever="@mdo"
                        ...
                        <form>
                            <div class="row">
                                <div class="mb-3 col-6">
                                    ...
                                    <div class="form-text"><strong> Keyboard Shortcuts: Copy </strong> -> CTRL + C and
                                        Paste
                                        -> CTRL + V</div>
                                </div>
                                <div class="mb-3 col-6">
    ...
    methods: {
        ...
        deleteType(type) {
            this.$swal({
                ...
                if (result.isConfirmed) {
                    $fetch(`${API_BASE_URL}api/user/deleteType/` + this.getId + "/" + type, {
                        method: 'PUT',
                    }).then(res => {
                        this.$swal({
        ...
        addflashCard() {
            ...
            if (data.type === "") {
                ...
                $fetch(`${API_BASE_URL}api/user/flashCard/` + this.getId, {
                    method: 'POST',
                    body: data
                }).then(res => {
                    this.$store.dispatch("SetFlashcard");
        ...
        addType() {
            if (this.typevlue == "") {
                ...
                $fetch(`${API_BASE_URL}api/user/types/` + this.getId + "/" + this.typevlue, {
                    method: "POST",
                }).then(res => {
                    this.$swal({
                        icon: "success",
        ...
        deleteCard(data) {
            this.$swal({
                ...
                if (result.isConfirmed) {
                    $fetch(`${API_BASE_URL}api/user/flashcard2/` + this.getId + "/" + data.unqie, {
                        method: 'PUT',
                    }).then(res => {
                        this.$swal({
                            title: "Delete successfully!",
