...
export default {
    ...
    methods: {
        ...
        endQuize() {
            ...
            $fetch("${API_BASE_URL}api/user/endquize/" + this.getId, {
                method: 'POST',
                body: data
            }).then(res => {
        ...
        note(res, note) {
            ...
            $fetch(`${API_BASE_URL}api/user/note/` + this.getId, {
                method: 'POST',
                body: data
            }).then(res => {
                this.Note = ""
        ...
        mark(res) {
            ...
            $fetch(`${API_BASE_URL}api/user/matchmark/` + this.getId + "/" + res.id, {
                method: 'PUT',
            }).then(res => {
                console.log("res");
            }).catch(err => {
        ...
        showSwal(res, e) {
            ...
            if (res.answer1 === this.corectAnswer12) {
                this.correctAnswer++
                $fetch(`${API_BASE_URL}api/user/matchcorrect/` + this.getId + "/" + res.id, {
                    method: 'PUT',
                }).then(res => {
                    console.log("res");
                ...
                $fetch(`${API_BASE_URL}api/user/matchomitted/` + this.getId + "/" + res.id, {
                    method: 'PUT',
                ...
                $fetch(`${API_BASE_URL}api/user/match/` + this.getId + "/" + res.id, {
                    method: 'PUT',
