    ...
    methods: {
        ...
        async GenerateQuize() {
            if (this.TypeQustion.length != 0) {
                ...
                await $fetch(`${API_BASE_URL}api/question/findone`, {
                    method: 'POST',
                    body: this.filtring
                }).then(res => {
            ...
            if (this.TypeQustion.length != 0) {
                this.TypeQustion.forEach(element => {
                    if (element === 'Incorrect') {
                        ...
                        $fetch(`${API_BASE_URL}api/user/findQustionincorrect/` + this.getId, {
                            method: 'POST',
                            body: this.filtring
                        }).then(res => {
                            if (res.length == 0) {
                        ...
                        $fetch(`${API_BASE_URL}api/user/findQustionomitted/` + this.getId, {
                            method: 'POST',
                            body: this.filtring
                        }).then(res => {
                            if (res.length == 0) {
                        ...
                        console.log("correct Here");
                        $fetch(`${API_BASE_URL}api/user/findQustioncorrect/` + this.getId, {
                            method: 'POST',
                            body: this.filtring
                        }).then(res => {
                            if (res.length == 0) {
                    ...
                    if (element === "Mark") {
                        ...
                        $fetch(`${API_BASE_URL}api/user/findQustionmark/` + this.getId, {
                            method: 'POST',
                            body: this.filtring
                        }).then(res => {
                            if (res.length == 0) {
