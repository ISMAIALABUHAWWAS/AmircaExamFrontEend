                                ...
                                <form role="form" class="text-start">
                                    ...
                                    <div class="mb-3">
                                        <ArgonInput id="password" type="password" placeholder="Password"
                                            aria-label="Password" v-model="userInfo.password"
...
export default {
    ...
    methods: {
        ...
        async login(userInfo) {
            if (this.Validation()) {
                ...
                await $fetch(`${API_BASE_URL}api/authorization`, {
                    method: 'POST',
                    body: userInfo
                }).then(res => {
    ...
    mounted() {
        // You can access the runtime config here (this can be useful for server-side things as well)
