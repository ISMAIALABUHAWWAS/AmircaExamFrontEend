...
const store = createStore({
    ...
    actions: {
        ...
        SetFlashcard: ({ commit, state }) => {
            $fetch(`${API_BASE_URL}api/user/flashcard/` + state.id, {
                method: "GET",
            })
                .then((res) => {
                    console.log(res);
        ...
        SetTypes: ({ commit, state }) => {
            $fetch(`${API_BASE_URL}api/user/typesget/` + state.id, {
                method: "GET",
            })
                .then((res) => {
                    console.log(res);
        ...
        SetNotes: ({ commit, state }) => {
            $fetch(`${API_BASE_URL}api/user/note/` + state.id, {
                method: "GET",
            })
                .then((res) => {
                    console.log(res);
        ...
        SetUserCourses: ({ commit, state }) => {
            $fetch(`${API_BASE_URL}api/user/getcourses/` + state.id, {
                method: "GET",
            })
                .then((res) => {
                    console.log(res);
        ...
        SetPreviousQuize: ({ commit, state }) => {
            $fetch(`${API_BASE_URL}api/user/myquizes/` + state.id, {
                method: "GET",
            })
                .then((res) => {
                    console.log(res);
